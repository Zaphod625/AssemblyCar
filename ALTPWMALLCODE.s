...
Stop_Car:
    ...
    movlw   0                    ; 0% duty cycle Left motor
    movwf   CCPR1L   
    bcf     CCP1CON,4
    bcf     CCP1CON,5
    
    movlw   0                    ; 0% duty cycle Right motor
    movwf   CCPR2L 
    bcf     CCP2CON,4
    bcf     CCP2CON,5
...
Left_Left:
    ; 90-degree left turn - Left motor reverse, right motor forward at maximum differential
    bsf     LATB,6    ;left motor          
    bcf     LATB,7     ;right motor          
...
Right_Right:
    ; 90-degree right turn - Right motor reverse, left motor forward at maximum differential
    bcf     LATB,6  ;left motor
    bsf     LATB,7  ;right motor  
