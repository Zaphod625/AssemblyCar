...
CaliWhite:
    ...
    MOVLW   0xE1
    //ADDLW   0x1A	; add a 100mV on top of the Measured ADC reading for the logic to see whta colour we are reading
    MOVWF   WhiteVal    
    MOVLW   0b00000001
    MOVWF   PORTD;
    CALL    Delay3Hz
...
CaliRed:
    ...
    MOVF    ADRESH, W  ; Store current ADC reading in BlackVal
    MOVLW   0x9F
    //ADDLW   0x0D	; add a 100mV on top of the Measured ADC reading for the logic to see whta colour we are reading
    MOVWF   RedVal    
    CALL    Delay3Hz
    MOVLW   0b00010010
    MOVWF   PORTD;
