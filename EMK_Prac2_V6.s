...
Calibrate_ver_RGB:
	...
	;sensor_ML
	MOVLW   0b00010101                          ; Select ADC Channel AN5 -> RE0 (sensor_ML)
	MOVWF   ADCON0
	CALL    ADC_Start
	MOVF    ADRESH, W			    			    
	;ADDLW   0b00001010
	...
	;sensor_RR
	MOVLW   0b00011001                          ; Select ADC Channel AN7 -> RE2 (sensor_RR)
	MOVWF   ADCON0
	CALL    ADC_Start
	MOVF    ADRESH, W			    			    
	;ADDLW   0b00001010
	...
	;sensor_LL
	MOVLW   0b00011101                          ; Select ADC Channel AN6 -> RE1 (sensor_LL)
	MOVWF   ADCON0
	CALL    ADC_Start
	MOVF    ADRESH, W			    			    
	;ADDLW   0b00001010
...
GO_Straight:
    ...
    movlw   0x0F           ; right wheel turns  very slowly
    movwf   PWM2
